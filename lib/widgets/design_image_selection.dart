...
class DesignImageSelection extends StatelessWidget {
    ...
    return Column(
      children: [
        GestureDetector(
          ...
          child: Container(
            width: displayImage!.path.isNotEmpty ? Get.width : 0,
            height: displayImage!.path.isNotEmpty ? Get.width : 0,
            decoration: BoxDecoration(
              color: DesignColor.text300,
              image: displayImage?.path.isNotEmpty != null
                  ? DecorationImage(
